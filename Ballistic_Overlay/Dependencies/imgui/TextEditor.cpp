...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::Lua()
{
	...
	if (!inited)
	{
		...
		static const char* const identifiers[] = {
			...
			/* Closure library */
			"newcclosure", "new_cclosure", "NewCClosure",
			"islclosure", "is_lclosure", "IsLClosure",
			"iscclosure", "is_cclosure", "IsCClosure",
			"loadstring", "Loadstring",

			/* Script library */
			"getreg", "get_reg", "GetReg",
			"getgenv", "get_genv", "GetGenv",
			"setthreadidentity", "set_thread_identity", "SetThreadIdentity",
			"setthreadcontext", "set_thread_context", "SetThreadContext",
			"setidentity", "set_identity", "SetIdentity",
			"getthreadidentity", "get_thread_identity", "GetThreadIdentity",
			"getthreadcontext", "get_thread_context", "GetThreadContext",
			"getidentity", "get_identity", "GetIdentity",
			"identifyexecutor", "identify_executor", "IdentifyExecutor",
			"getexecutorname", "get_executor_name", "GetExecutorName",
			"gethui", "get_hui", "GetHui",
			"getcallbackvalue", "get_callback_value", "GetCallbackValue",

			/* Vanilla Lua functions */
			"assert", "collectgarbage", "dofile", "error", "getmetatable", "ipairs", "loadfile", "load",  "next",  "pairs",  "pcall",  "print",  "rawequal",  "rawlen",  "rawget",  "rawset",
